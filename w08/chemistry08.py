...
def main():
    ...
    parse = parse_formula(molecular_formula, periodic_table)
    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    molar_mass = compute_molar_mass(parse, periodic_table)
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for symbol in symbol_quantity_list:
        ...
        element_abbrev = symbol[0]
        element_quantity = symbol[1]
        # Get the atomic mass for the symbol from the dictionary.
        atomic_mass = periodic_table_dict[element_abbrev][1]
        # Multiply the atomic mass by the quantity.
        product = atomic_mass * element_quantity
