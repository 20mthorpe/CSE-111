from sentences import get_determiner, get_noun, get_verb, get_preposition, get_adjective, get_prepositional_phrase
import random
import pytest
...
def test_get_preposition():
    ...
    for _ in range(4):
        ...
        # is one of the words in the preposistions list.
        assert word in prepositions

def test_get_adjective():

    adjectives = ["happy", "sad", "excited", "nervous", "sentimental"]
